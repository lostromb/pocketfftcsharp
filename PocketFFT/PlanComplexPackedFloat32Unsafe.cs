...
namespace PocketFFT
{
    internal class PlanComplexPackedFloat32Unsafe : IComplex1DFFTPlanFloat32
    {
        internal int length;
        internal int nfct;
        internal cmplxF[] mem;
        ...
        public PlanComplexPackedFloat32Unsafe(int length)
        {
            if (length == 0)
            {
        ...
        private unsafe void pass_all(cmplxF* c, float fct, int sign)
        {
            if (this.length == 1)
            {
                return;
            ...
            fixed (cmplxF* ch = scratchArray)
            fixed(cmplxF* memPtr = this.mem)
            {
                cmplxF* p1 = c;
                cmplxF* p2 = ch;
                ...
                if (p1 != c) // pointer address comparison
                {
                    ...
                    {
                        Unsafe.CopyBlock(c, p1, (uint)(len * sizeof(cmplxF)));
                    }
                }
                else
                {
        ...
        private static unsafe void pass2b(int ido, int l1, cmplxF* cc, cmplxF* ch, cmplxF* wa)
        {
            const int cdim = 2;
        ...
        private static unsafe void pass2f(int ido, int l1, cmplxF* cc, cmplxF* ch, cmplxF* wa)
        {
            const int cdim = 2;
        ...
        private static unsafe void pass3b(int ido, int l1, cmplxF* cc, cmplxF* ch, cmplxF* wa)
        {
            const int cdim = 3;
        ...
        private static unsafe void pass3f(int ido, int l1, cmplxF* cc, cmplxF* ch, cmplxF* wa)
        {
            const int cdim = 3;
            const float tw1r = -0.5f, tw1i = -0.86602540378443864676f;
        ...
        private static unsafe void pass4b(int ido, int l1, cmplxF* cc, cmplxF* ch, cmplxF* wa)
        {
            const int cdim = 4;
        ...
        private static unsafe void pass4f(int ido, int l1, cmplxF* cc, cmplxF* ch, cmplxF* wa)
        {
            const int cdim = 4;
        ...
        private static unsafe void pass5b(int ido, int l1, cmplxF* cc, cmplxF* ch, cmplxF* wa)
        {
            const int cdim = 5;
        ...
        private static unsafe void pass5f(int ido, int l1, cmplxF* cc, cmplxF* ch, cmplxF* wa)
        {
            const int cdim = 5;
            const float tw1r = 0.3090169943749474241f,
                tw1i = -0.95105651629515357212f,
        ...
        private static unsafe void pass7(int ido, int l1, cmplxF* cc, cmplxF* ch, cmplxF* wa, int sign)
        {
            const int cdim = 7;
        ...
        private static unsafe void pass11(int ido, int l1, cmplxF* cc, cmplxF* ch, cmplxF* wa, int sign)
        {
            const int cdim = 11;
        ...
        private static unsafe void passg(int ido, int ip, int l1, cmplxF* cc, cmplxF* ch, cmplxF* wa, cmplxF* csarr, int sign)
        {
            int cdim = ip;
            int ipph = (ip + 1) / 2;
            int idl1 = ido * l1;
